...
select * from students
where created_on  ='2021-03-26 00:00:000';
...
--15. Вывести пользователей которые были созданы 2021-01-23 00:00:00.000 и у которых в имени есть слово Andrey
select name from students
where created_on = '2021-01-23 00:00:00.000' and name like 'Andrey';

--16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8
select * from students
where name = '8' and created_on  = '2021-01-23 00:00:00.000';
